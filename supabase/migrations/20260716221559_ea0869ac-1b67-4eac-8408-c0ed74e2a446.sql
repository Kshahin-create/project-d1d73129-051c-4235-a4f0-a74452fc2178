...
-- telegram_chat_memory: add explicit service_role manage policy for clarity
CREATE POLICY "Service role can manage chat memory" ON public.telegram_chat_memory FOR ALL TO service_role USING (true) WITH CHECK (true);

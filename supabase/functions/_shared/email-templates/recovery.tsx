...
export const RecoveryEmail = ({ confirmationUrl }: RecoveryEmailProps) => (
  <Html lang="ar" dir="rtl">
    <Head />
    <Preview>إعادة تعيين كلمة المرور — {SITE_NAME}</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Section style={card}>
          ...
          <Text style={text}>
            استلمنا طلب إعادة تعيين كلمة المرور الخاصة بحسابك في {SITE_NAME}.
          ...
          <Text style={footer}>
            إذا لم تطلب إعادة التعيين، تجاهل هذه الرسالة وستظل كلمة مرورك كما هي.
          </Text>
        </Section>
      </Container>
    </Body>
